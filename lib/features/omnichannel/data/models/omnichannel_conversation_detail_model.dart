  ...
  factory OmnichannelConversationDetailModel.fromSources({
    ...
    final botEnabled =
        ...
        (!(omnichannelFirstMappedFromSources<bool>(
              ...
              (value) {
                final direct = omnichannelBool(value);
                if (direct != null) {
                  return direct;
                }

                return omnichannelString(value) == 'admin';
              },
            ) ??
            false));
    final isHumanTakeover =
        omnichannelFirstMappedFromSources<bool>(
          candidates,
          const <String>[
            'bot_control.human_takeover',
        ...
        false;
    final botAutoResumeAt = omnichannelFirstMappedFromSources<String>(
      candidates,
      const <String>[
        'bot_control.auto_resume_at',
        'bot.bot_auto_resume_at',
        'bot_auto_resume_at',
      ],
      omnichannelString,
    );
    final botAutoResumeEnabled =
        omnichannelFirstMappedFromSources<bool>(candidates, const <String>[
          'bot_control.auto_resume_enabled',
          'bot.bot_auto_resume_enabled',
          'bot_auto_resume_enabled',
        ], omnichannelBool) ??
        (botAutoResumeAt != null && !botEnabled);
    final botAutoResumeAfterMinutes =
        omnichannelFirstMappedFromSources<int>(candidates, const <String>[
          'bot_control.auto_resume_after_minutes',
          'bot.bot_auto_resume_after_minutes',
  ...
  OmnichannelConversationDetailModel mergeWith(
    ...
    return OmnichannelConversationDetailModel(
      ...
      customerName: other.customerName.trim().isNotEmpty
          ...
          : customerName,
      customerContact:
          other.customerContact.trim().isNotEmpty &&
      ...
      botAutoResumeEnabled: other.id > 0
          ? other.botAutoResumeEnabled
          : botAutoResumeEnabled,
